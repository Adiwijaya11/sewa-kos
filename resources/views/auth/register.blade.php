@extends('layouts.app')
@section('title', 'Daftar sebagai Renter - KosinAja')
...
<div class="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-slate-50">
    <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl border border-slate-100 shadow-xl shadow-slate-200/50">
        ...
        <div class="text-center">
            ...
            <h2 class="mt-4 text-2xl font-extrabold text-slate-900 tracking-tight">Daftar Akun Renter</h2>
            <p class="mt-2 text-sm text-slate-500">
                Dapatkan kemudahan mencari, mem-booking, dan menyewa kos modern secara instan dan aman.
            </p>
        </div>
        ...
        <form class="mt-8 space-y-4" action="{{ route('register') }}" method="POST">
            ...
            <!-- Phone Number -->
            <div>
                <label for="phone" class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-2">Nomor Telepon (WhatsApp)</label>
                <div class="relative">
                    <span class="absolute inset-y-0 left-0 pl-3.5 flex items-center text-slate-400">
            ...
            <p class="text-[11px] text-slate-500 leading-normal">
                Dengan mendaftar, Anda menyetujui <a href="#" class="text-emerald-600 font-semibold">Syarat & Ketentuan</a> serta Kebijakan Privasi KosinAja demi kenyamanan bersama.
            </p>
        ...
        <div class="border-t border-slate-100 pt-6 text-center">
            <p class="text-xs text-slate-500">
                Sudah memiliki akun? <a href="{{ route('login') }}" class="font-bold text-emerald-600 hover:text-emerald-700 transition-colors">Masuk di sini</a>
            </p>
        </div>
    </div>
</div>
